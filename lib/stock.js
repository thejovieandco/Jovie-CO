...
// Effectively live. New orders record their contents in session metadata,
// so a refresh costs a single Stripe call — the brief window only absorbs
// bursts of traffic hitting the same second.
...
export function decodeItemsMetadata(metadata) {
